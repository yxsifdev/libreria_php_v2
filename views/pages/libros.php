...
<body>
    ...
    <header>
        ...
        <div class="actions-btns">
            <a href="../user/perfil.php?id=<?php echo $_SESSION['user_id']; ?>" class="btn-username"><?php echo $_SESSION['user_name'] ?></a>
    ...
    <main>
        <?php foreach ($libros as $libro) : ?>
            <div class="box-books">
                <a href="option.php?id=<?php echo $libro['id']; ?>"><img width="150px" height="200px" src="<?php echo $libro['portada'] ?>" alt=""></a>
