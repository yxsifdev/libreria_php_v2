...
<head>
    ...
    <title>Litzy</title>
    <link rel="stylesheet" href="styles/inscribirse.css">
...
<body>
    ...
    <!--  -->
    <div class="box-inscribirse">
        <div class="card-inscribirse">
            <h1>Inscribirse</h1>
            <?php
            ...
            <div class="yes-register">
                <p>¿Ya tienes una cuenta de Litzy? <a href="login.php">Accede aquí</a></p>
            </div>
            <div class="form-inscribirse">
                <form action="../../actions/auth/registerProcess.php" method="post">
                    ...
                    <button type="submit" name="registerProcess">Acceder</button>
                </form>
                <div class="no-login">
                    <p>Al continuar, aceptas nuestros <a href="#">Términos y condiciones</a></p>
                </div>
            </div>
        </div>
    </div>
...
<style>
    * {
    ...
    .form-inscribirse form input::placeholder {
        font-size: 16px;
        color: #999;
    }

    .form-inscribirse form input:focus {
    ...
    .form-inscribirse .no-login p {
        font-size: 13px;
        text-align: center;
        font-weight: 600;
    }

    .form-inscribirse .no-login p a {
        color: #F6B606;
        font-weight: 700;
    }

    .card-inscribirse .yes-register p {
        font-size: 13px;
        text-align: center;
        margin-bottom: 25px;
        font-weight: 600;
    ...
    .card-inscribirse .yes-register p a {
        color: #F6B606;
        font-weight: 700;
    }
